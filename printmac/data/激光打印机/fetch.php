...
//------------------------------------------------------------
	...
	for($t = 1 ; $t <$tabCount;$t++){
		...
		if(preg_match($r,$arr[0],$arrC)){
			...
			echo $rightTag[0];
			// 基本参数-------------7b5d0cd8c791b48d0348f4031346b22a
			// 打印性能-------------fc0916ee31ede8ab37ff504c7b8b4f7b
			// 介质规格-------------4e7aa18d7976857c1aaa794f6e2955ab
			// 耗材-------------cb1942196f93fda8505dcae810ce1490
			// 其它参数-------------46a237946b00b127c8d19b87f7c6c1c7
			// 激光打印机附件-------------b955285307b46537b1e724c1b1fc278c
			// 保修信息-------------2404eaffe1568fc9b86c674dd90fd0e7
			//1基本参数
			if(md5($rightTag[0]) == "7b5d0cd8c791b48d0348f4031346b22a"){
				// echo "--------------基本参数-------------";
				if($t == $tabCountLowOne){
			...
			//4耗材
			else if(md5($rightTag[0]) == "cb1942196f93fda8505dcae810ce1490"){
				if($t == $tabCountLowOne){
			...
			//5其它参数
			else if(md5($rightTag[0]) == "46a237946b00b127c8d19b87f7c6c1c7"){
				if($t == $tabCountLowOne){
