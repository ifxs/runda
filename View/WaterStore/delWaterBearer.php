...
<div class="body">
    <div>
	   <table class="table table-bordered table-hover">
	       <tr><td><input type="checkbox" id="checkAll"/>全选</td><td>送水工账号ID</td><td>最大载重量</td><td>状态</td><td>详细信息</td></tr>
	       <?php
	       if($waterbearers != null){
	            foreach ($waterbearers as $key=>$value){
	               echo '<tr><td><input type="checkbox" name="waterBearers[]" value="'.$value['id'].'"/></td><td>'.$value['userId'].'</td><td>'.$value['maxLoadCapacity'].'</td><td>'.$waterBearerStatueArray[$value['statue']].'</td><td><a href="">详细信息</a></td></tr>';
	            }
	       }
	       ?>
        </table>
