...
insert into role(id,roleName) values(0,'普通用户');insert into role(id,roleName) values(1,'送水工人');insert into role(id,roleName) values(2,'水店店长');insert into role(id,roleName) values(3,'管理员');";

insert into user(userName,passWord,nickName,sex,realName,phoneNumber,email,role,province,city,country,detailAddress) values('adminrunda','f27de3302890370a6fd35d1cfd3e51b2','admin','男','管理员','runda','ifxs@ifxs',3,'贵州','贵阳','花溪','贵州大学北校区');";

insert into waterStoreStatue(id,waterStoreStat) values(0,'正常营业');insert into waterStoreStatue(id,waterStoreStat) values(1,'忙碌中');insert into waterStoreStatue(id,waterStoreStat) values(2,'休息中');";

insert into waterStoreAuditStatus(id,auditStat) values(0,'待审核');insert into waterStoreAuditStatus(id,auditStat) values(1,'审核通过');insert into waterStoreAuditStatus(id,auditStat) values(2,'审核失败');";

insert into waterBearerStatue(id,waterBearerStat) values(0,'正常工作');insert into waterBearerStatue(id,waterBearerStat) values(1,'忙碌中');insert into waterBearerStatue(id,waterBearerStat) values(2,'休息中');";
